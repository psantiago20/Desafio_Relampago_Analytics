...
pacman::p_load(
  ...
  gtsummary,   # Criação de tabelas sumarizadas
  ggplot2,     # Visualização de dados
  devtools,     # Para instalação de pacotes via GitHub
  broom)        #facilita o processamento e a organização dos resultados de modelos estatísticos.


# Instalar e carregar pacote para leitura de arquivos DBC
#devtools::install_github("danicat/read.dbc")
library(read.dbc)

# Definir o diretório de trabalho
setwd("/Users/romualdo/Library/CloudStorage/GoogleDrive-jpromualdo0@gmail.com/My Drive/mundo-academico/DR/Aulas/R/Boletim/HIVG copy")

# Carregar todos os arquivos DBC do diretório
arquivos_dbc <- list.files(
  path = "/Users/romualdo/Library/CloudStorage/GoogleDrive-jpromualdo0@gmail.com/My Drive/mundo-academico/DR/Aulas/R/Boletim/HIVG copy",
  pattern = "\\.dbc$",
  full.names = TRUE
)
lista_dados <- lapply(arquivos_dbc, read.dbc)
data_raw <- do.call(rbind, lista_dados)  # Combinar todos os arquivos em um único dataframe


##############################Avaliar duplicatas e dados########################
...
###################Tabela Escolaridade,raca,ano,idade###########################
...
#########################Casos acomulados por região/ano ###########################
...
# mutate()# Agregar os dados por ano e região
...
##################### Momento do Diagnostico x idade############################
