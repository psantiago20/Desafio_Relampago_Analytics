...
* **Gargalos do Sistema:** Os dados evidenciam que o gargalo crítico não está no diagnóstico nem na primeira vinculação ao pré-natal, mas sim na ampliação da taxa de manutenção da Terapia Antirretroviral (TARV) ao longo dos meses da gestação, essencial para que a maioria alcance essa dispensa com segurança, especialmente nas regiões Norte e Nordeste onde as perdas são mais severas e os desafios de acesso e continuidade do cuidado são estruturalmente maiores.
    """)
